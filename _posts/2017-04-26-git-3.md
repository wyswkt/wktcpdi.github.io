...
![图片9](/images/posts/git-3/405_commitlog.png)
...
![图片12](/images/posts/git-3/408_tgit_push.png)

一般保持默认,点击 “**确定**” 按钮.

然后弹出推送进度界面, 可能要求你输入用户名:

![图片13](/images/posts/git-3/409_username.png)

确定OK，然后要求输入密码:

![图片14](/images/posts/git-3/410_pass.png)
...
![图片17](/images/posts/git-3/413_pull_dialog.png)
